...
public class SyncManager {
     ...
     */
    protected void updateLastSyncTimeInDB(LocalDateTime syncTime, Connection localConnection) throws SQLException {
    ...
    public static void main(String[] args) throws IOException {
      ...
      SyncManager syncManager = new SyncManager(List.of(syncCustomer, syncAddress));
